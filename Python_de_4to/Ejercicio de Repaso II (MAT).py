...
b1= float(input("elija una medida para la altura de su primer rectangula"))
a2= float(input("elija una medida para la base de su segundo rectangulo "))
b2= float(input("elija una medida para la altura de su segundo rectangula"))
a3= float(input("elija una medida para la base de su tercer rectangulo "))
b3= float(input("elija una medida para la altura de su tercer rectangula"))
r1= a1*b1
r2= a2*b2
r3= a3*b3
if r1>r2:
